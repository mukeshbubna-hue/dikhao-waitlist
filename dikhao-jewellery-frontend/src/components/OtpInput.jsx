    ...
    <div className="flex gap-2 justify-center" onPaste={handlePaste}>
      {digits.map((d, i) => (
        <input
          ...
          className={`w-11 h-13 py-3 text-center text-xl text-plum bg-warm-white border outline-none transition-colors font-body ${
            d ? 'border-plum/50' : 'border-plum/20 focus:border-plum'
          }`}
        />
      ))}
    </div>
